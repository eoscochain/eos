...
void kafka::push_block(const chain::block_state_ptr& block_state, bool irreversible) {
    ...
    {
        const auto& t = db.get<stats_object>();
        db.modify(t, [&](stats_object &t) {
           t.tx_count += b->tx_count;
           t.action_count += b->action_count;
           t.context_free_action_count += b->context_free_action_count;
           if (b->tx_count > t.max_tx_count_per_block) {
               t.max_tx_count_per_block = b->tx_count;
           }
           if (b->action_count > t.max_action_count_per_block) {
               t.max_action_count_per_block = b->action_count;
           }
           if (b->context_free_action_count > t.max_context_free_action_count_per_block) {
               t.max_context_free_action_count_per_block = b->context_free_action_count;
           }

           b->stats.tx_count = t.tx_count;
           b->stats.action_count = t.action_count;
           b->stats.context_free_action_count = t.context_free_action_count;
           b->stats.max_tx_count_per_block = t.max_tx_count_per_block;
           b->stats.max_action_count_per_block = t.max_action_count_per_block;
           b->stats.max_context_free_action_count_per_block = t.max_context_free_action_count_per_block;
           b->stats.account_count = t.account_count;
           b->stats.token_count = t.token_count;
        });
    }
